...
export const config = {
  matcher: [
    ...
    "/((?!login|auth/callback|api/auth|api/worker|api/cron|api/runs/import|api/step-media/import|api/recipes/reindex|api/shopping/[^/]+/complete|_next/static|_next/image|favicon.ico|icon|apple-icon|illustrations|.*\\.(?:png|jpg|jpeg|webp|svg|ico|txt|xml)).*)",
  ],
};
